...
<html lang="en">
  ...
  <body style="font-family: sans-serif; background: linear-gradient(#6495ed, #ffffff); color: #151b54; margin: 0; padding: 0; width: 100%; text-align: center;">
    <div style="max-width: 90%; margin: 20px auto; padding: 20px; background-color: #ffffff; box-shadow: 0px 4px 12px rgba(0, 0, 0, 0.1);">
